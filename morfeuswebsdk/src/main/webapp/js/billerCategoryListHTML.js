(function(window){
	...
	function billerCategoryListHTMLAdaptor(templateName, resp){

		var container = "messages";
		var listData = [];
		var category = resp.payload.billerCategories || [];
		...
		for (var j = 0; j < data.length; j++) {
		    ...
		    if (elementStyle == "caption" && j == 0) {
		        ...
		        var title = (category[j].biller_category_name) ? category[j].biller_category_name : "";
	...
	window.billerCategoryListHTMLAdaptor = billerCategoryListHTMLAdaptor;
